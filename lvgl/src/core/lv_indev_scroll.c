...
void _lv_indev_scroll_throw_handler(_lv_indev_proc_t * proc)
{
    ...
    if(proc->types.pointer.scroll_dir == LV_DIR_VER) {
        ...
        /*With snapping find the nearest snap point and scroll there*/
            ...
            lv_obj_scroll_by(scroll_obj, 0, diff_y + y, lv_obj_has_flag(scroll_obj, LV_OBJ_FLAG_SCROLL_SNAP_NO_ANIM) ? LV_ANIM_OFF : LV_ANIM_ON);
        }
    }
        ...
        /*With snapping find the nearest snap point and scroll there*/
            ...
            lv_obj_scroll_by(scroll_obj, x + diff_x, 0, lv_obj_has_flag(scroll_obj, LV_OBJ_FLAG_SCROLL_SNAP_NO_ANIM) ? LV_ANIM_OFF : LV_ANIM_ON);
        }
    }
                               ...
                               lv_dir_t dir)
{
    if(lv_obj_has_flag(scroll_obj, LV_OBJ_FLAG_SCROLL_ELASTIC)) {
        ...
        if(scroll_end < 0) {
            ...
            if (lv_obj_has_flag(scroll_obj, LV_OBJ_FLAG_SCROLL_ELASTIC_NO_SLOW)) {
                return diff;
            }
