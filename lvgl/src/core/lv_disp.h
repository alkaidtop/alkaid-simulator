...
typedef enum
{
    ...
    LV_SCR_LOAD_ANIM_EXIT_OVER_LEFT,
    LV_SCR_LOAD_ANIM_EXIT_OVER_RIGHT,
    LV_SCR_LOAD_ANIM_EXIT_OVER_TOP,
    LV_SCR_LOAD_ANIM_EXIT_OVER_BOTTOM,
    LV_SCR_LOAD_ANIM_MASK_ZOOM_IN,
    LV_SCR_LOAD_ANIM_EXIT_MASK_ZOOM_OUT,
} lv_scr_load_anim_t;
